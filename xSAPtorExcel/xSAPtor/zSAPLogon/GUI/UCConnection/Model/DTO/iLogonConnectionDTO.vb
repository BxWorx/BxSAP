...
Namespace	Main.SAPLogon
	...
	Friend	Interface	iLogonConnectionDTO
		...
		#Region "Methods: Exposed"
			Sub Reset(Optional	ByVal	IsNew		As	Boolean	=	False,
								Optional	ByVal	CanEdit	As	Boolean	=	False)

			Function ShallowCopy()	As iLogonConnectionDTO
